...
function collectMapping() {
  return {
    ...
    pos: $("map_pos").value,
    definition: $("map_definition").value,
...
function applyFieldOptions(fields) {
  const ids = ["map_word","map_phonetic","map_pos","map_definition","map_meanings","map_examples","map_pageUrl","map_createdAt"];
  ...
  $("map_definition").value = byName(["Definition","Explain","Explanation","Giải thích","Giai thich","Note","Notes"]) || "";
  $("map_meanings").value = byName(["Meaning","Meanings","Vietnamese","Vi"]) || "";
...
async function loadSavedConfig() {
  ...
  if (anki_default_config.model) {
    ...
    $("map_pos").value = m.pos || "";
    $("map_definition").value = m.definition || "";
